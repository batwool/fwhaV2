...
const Haslet = () => {
  ...
  const faqData = [
    {
      question: "How does Haslet's rapid growth affect HVAC system selection?",
      answer: "With many new construction homes in Haslet, we recommend energy-efficient systems that complement modern building standards. We consider factors like improved insulation in newer homes and can help select systems with optimal SEER ratings for maximum efficiency."
    },
    {
      question: "What HVAC considerations are important for Haslet's newer homes?",
      answer: "Newer Haslet homes often feature open floor plans that require careful HVAC zoning. We specialize in designing systems that provide even cooling and heating throughout these spacious layouts, including multi-stage units and zoning solutions for optimal comfort."
    },
    {
      question: "How can I prepare my HVAC system for Haslet's windy spring seasons?",
      answer: "Haslet's frequent spring winds can bring dust and allergens. We recommend high-quality air filters, regular maintenance to clean coils and components, and ensuring proper sealing around outdoor units to prevent debris accumulation that reduces efficiency."
    },
    {
      question: "Do you handle HVAC permits for Haslet's specific requirements?",
      answer: "Yes, we manage all necessary permits with the City of Haslet and ensure compliance with local codes, including noise ordinances for outdoor units in residential areas and efficiency standards for new construction projects."
    }
  ];
  ...
  const services = [
    {
      title: "AC Services",
      description: "Expert cooling solutions for Haslet's hot summers",
      details: "From maintenance to emergency repairs, we handle all your cooling needs. We specifically recommend systems with enhanced humidity control for Haslet's climate.",
      localTip: "Essential for newer homes in developments like Harvest and Avondale with large windows that increase cooling demands"
    },
    {
      title: "Heating Services",
      description: "Reliable heating for North Texas winters",
      details: "Keep your home warm during our occasional cold snaps. We specialize in efficient furnace solutions and heat pumps that work well in Haslet's climate.",
      localTip: "Many newer Haslet homes benefit from high-efficiency systems that pair well with modern insulation"
    },
    {
      title: "Indoor Air Quality",
      description: "Breathe easier in your Haslet home",
      ...
      localTip: "Particularly important during spring when winds carry pollen from surrounding rural areas"
    },
    {
      ...
      localTip: "Schedule maintenance before summer to ensure systems are ready for peak cooling demand"
    }
  ];

  const localLandmarks = [
    {
      name: "Haslet Community Center",
      description: "A hub for community events and gatherings in the heart of Haslet"
    },
    {
      name: "Haslet Public Library",
      description: "Serving the community with resources and programs for all ages"
    },
    {
      name: "Harvest Development",
      description: "One of Haslet's premier residential communities with extensive amenities"
    },
    {
      name: "Avondale Haslet",
      description: "A growing residential area featuring modern homes and community spaces"
    }
  ];
  ...
  return (
    <div className="bg-white min-h-screen">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-[#003049] border-opacity-20">
              ...
              <div className="bg-[#003049] text-white py-8 px-6 text-center relative">
                ...
                <h1 className="text-3xl md:text-4xl font-bold text-white mb-3 relative z-10">
                  Professional HVAC Services in Haslet, TX
                </h1>

                {/* Description */}
                <p className="text-blue-100 relative z-10">
                  Expert heating, cooling, and indoor air quality solutions tailored to Haslet's unique climate
                </p>
              </div>
              ...
              <div className="p-6">
                <div className="flex flex-col items-center">
                  <p className="text-gray-700 text-center mb-6">
                    For over 15 years, we've been providing reliable HVAC services to Haslet residents and businesses.
                    As your local HVAC experts, we understand the specific challenges of maintaining comfort in Haslet's climate—from
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg mb-6 w-full">
                    <h3 className="font-semibold text-[#003049] mb-2 flex items-center">
                      Haslet Climate Insight:
                    </h3>
                    <p className="text-sm text-gray-700">
                      With average summer highs around 95°F and humidity frequently above 65%, quality AC is essential for comfort.
                      Winters can dip below freezing, making reliable heating equally important for our growing community.
                    </p>
                  </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#003049] mb-2 text-center">Serving the Haslet Community</h2>
            <p className="text-gray-600 text-center mb-8 max-w-3xl mx-auto">
              We're proud to be part of the Haslet community and understand the unique aspects of homes in our area
            </p>
            ...
            <div className="bg-blue-50 p-6 rounded-lg mb-12">
              ...
              <p className="text-gray-700 mb-4">
                Haslet has experienced significant growth in recent years, transforming from a small rural community to a thriving suburban city while maintaining its friendly atmosphere.
                Located in the far northern part of Tarrant County, Haslet offers residents a perfect blend of country living with modern conveniences and easy access to Fort Worth.
              </p>
              <p className="text-gray-700">
                Many homes in Haslet are newer constructions built in the last 20 years, featuring modern designs and energy-efficient features.
                We specialize in working with these contemporary homes, understanding their advanced HVAC requirements and opportunities for smart home integration.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <h3 className="text-xl font-semibold text-[#003049] mb-4">Haslet HVAC Considerations</h3>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Newer construction homes often benefit from advanced zoning systems</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#780000] mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path
                    ...
                    <span className="text-gray-700">Spring winds require enhanced filtration systems</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#780000] mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path
                    ...
                    <span className="text-gray-700">Energy-efficient systems maximize savings in newer well-insulated homes</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#780000] mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path
                    ...
                    <span className="text-gray-700">Knowledge of local permitting requirements for new construction</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#003049] mb-4">Our HVAC Services for Haslet Homes</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide comprehensive heating, cooling, and air quality solutions tailored to Haslet's unique climate needs
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#003049] mb-2 text-center">Complete HVAC Solutions for Haslet Homes</h2>
            <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
              Our team of certified technicians provides comprehensive HVAC services to keep your Haslet home comfortable through all North Texas seasons
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-[#003049] border-opacity-10">
                ...
                <p className="text-gray-700 mb-4">
                  Haslet's hot, humid summers demand reliable cooling systems. We provide comprehensive AC services to keep your home comfortable even during our extended heat seasons.
                </p>
                ...
                <div className="mt-4 p-3 bg-blue-50 rounded-md">
                  <p className="text-sm text-[#003049]">
                    <span className="font-medium">Haslet Tip:</span> Schedule AC maintenance in early spring before temperatures consistently reach the 90s.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-[#003049] border-opacity-10">
                ...
                <p className="text-gray-700 mb-4">
                  When North Texas experiences its occasional cold snaps, you need a reliable heating system. We offer comprehensive heating services to keep your Haslet home warm and comfortable.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-[#780000] rounded-full mr-3"></div>
                ...
                <div className="mt-4 p-3 bg-blue-50 rounded-md">
                  <p className="text-sm text-[#003049]">
                    <span className="font-medium">Haslet Tip:</span> Consider a heat pump system for efficient heating and cooling in our climate.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-[#003049] border-opacity-10">
                ...
                <p className="text-gray-700 mb-4">
                  Haslet's seasonal changes bring pollen, dust, and humidity that can affect indoor air quality. Our solutions help you breathe easier with cleaner, healthier air.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-[#780000] rounded-full mr-3"></div>
                ...
                <div className="mt-4 p-3 bg-blue-50 rounded-md">
                  <p className="text-sm text-[#003049]">
                    <span className="font-medium">Haslet Tip:</span> High-quality air filters are essential during spring when winds carry pollen from surrounding areas.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-[#003049] border-opacity-10">
                ...
                <div className="mt-4 p-3 bg-blue-50 rounded-md">
                  <p className="text-sm text-[#003049]">
                    <span className="font-medium">Haslet Tip:</span> Our maintenance plans include inspections tailored to our local climate challenges.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#003049] mb-2 text-center">Why Haslet Homeowners Choose Us</h2>
            <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
              We've built our reputation on quality service, technical expertise, and deep knowledge of the Haslet community
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg border border-[#003049] border-opacity-10">
                ...
                <p className="text-gray-700">
                  We understand Haslet's specific climate challenges, growth patterns, and housing styles.
              ...
              <div className="bg-white p-6 rounded-lg border border-[#003049] border-opacity-10">
                ...
                <p className="text-gray-700">
                  As neighbors serving neighbors, we take pride in supporting our local community. We understand the specific needs of Haslet homes,
                  many of which are newer constructions with modern HVAC requirements and energy efficiency goals.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg border border-[#003049] border-opacity-10">
                ...
                <p className="text-gray-700">
                  We're familiar with Haslet's building codes and permit requirements. We handle all necessary paperwork with the city,
              ...
              <div className="bg-white p-6 rounded-lg border border-[#003049] border-opacity-10">
                ...
                <p className="text-gray-700">
                  Located nearby, we can respond quickly to HVAC emergencies in Haslet. We know HVAC problems can't wait,
            ...
            <div className="mt-12 bg-[#003049] text-white p-6 rounded-lg">
              <div className="flex items-start">
                ...
                <div>
                  <p className="italic mb-2">"These folks really understand Haslet homes. They helped us select the perfect HVAC system for our new construction in the Harvest community. The zoning system they recommended keeps our entire home comfortable, and we're seeing significant energy savings!"</p>
                  <p className="font-medium">- The Martinez Family, Haslet residents since 2020</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white p-6 rounded-lg shadow-sm mb-8 border border-[#003049] border-opacity-10">
                <h2 className="text-2xl font-bold text-[#003049] mb-4">Serving Haslet & Surrounding Areas</h2>
                <p className="text-gray-700 mb-4">
                  We're proud to be the trusted HVAC service provider for Haslet and the surrounding communities.
                  Located in northern Tarrant County, Haslet offers a perfect blend of suburban living with country charm, and we understand the unique HVAC needs of homes in our growing community.
                </p>

                <p className="text-gray-700 mb-4">
                  Haslet has experienced significant growth in recent years, transforming from a small rural community to a thriving suburban city while maintaining its friendly atmosphere.
                  Our team responds quickly to service calls throughout the area and provides reliable, long-lasting solutions tailored to newer construction homes.
                </p>
                ...
                {/* Service Areas */}
                <div>
                  <h3 className="text-lg font-semibold text-[#003049] mb-3">We serve Haslet and surrounding communities including:</h3>
                  <div className="grid grid-cols-2 gap-2">
                    {["Fort Worth", "Keller", "Roanoke", "Trophy Club", "Saginaw", "Watauga", "North Richland Hills", "Southlake"].map((area) => (
      ...
      <section className="w-full bg-[#f8fafc] py-16">
        <div className="px-4 sm:px-8 lg:px-16 mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We've compiled answers to common questions about HVAC services specific to the Haslet area
            </p>
          </div>
      ...
      <section className="w-full bg-[#003049] py-16">
        <div className="px-4 sm:px-8 lg:px-16 mx-auto max-w-3xl text-center">
          <h2 className="text-2xl font-bold text-white sm:text-3xl mb-4">
            Ready for Reliable HVAC Service in Haslet?
          </h2>
      ...
      <section className="w-full bg-white py-16 relative">
        ...
        <div className="relative px-4 sm:px-8 lg:px-16 mx-auto max-w-5xl text-center z-10">
          <div className="inline-flex items-center justify-center mb-4 bg-blue-50 px-4 py-2 rounded-full">
            ...
            <span className="text-[#003049] font-medium">Same-Day Availability for Haslet Residents</span>
          </div>
          ...
          <p className="text-lg mb-10 max-w-2xl mx-auto text-gray-600">
            We aren't comfortable until you are. Our certified team provides expert service tailored to Haslet's unique climate and housing needs.
          </p>
