      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border-2 border-gray-300 transform rotate-1 transition-transform duration-300 hover:rotate-0 lg:flex lg:flex-row">
          ...
          <div className="p-8 bg-white relative lg:w-3/5">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#003049] focus:border-[#003049]"
                    placeholder="John"
                  />
                </div>
                <div>
              ...
              <button
                type="submit"
                className="w-full bg-[#003049] hover:bg-[#00283e] text-white font-bold py-3 px-4 rounded-lg shadow-md transition-all duration-300 transform hover:scale-105"
              >
        ...
        <div className="mt-8 text-center text-gray-600">
          <p>
            ...
            <a href="tel:8178000340" className="text-[#003049] font-semibold">
              (817) 800-0340
            </a>
          </p>
        </div>
